...
public class PostagemFormat {
     ...
     * padrao: aaaa-MM-dd.
     * 
     * @param dataPostagem. String recebida como paramero para aplicacao do novo padrao.
     * @return novaData. String representando uma data como um novo padrao de formatacao.
     */
